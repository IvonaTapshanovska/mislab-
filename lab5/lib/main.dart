...
import 'package:lab3/widget/calendar_widget.dart';
import 'package:lab3/widget/exam_widget.dart';
import 'package:lab3/widget/map_widget.dart';
...
class MainListScreenState extends State<MainListScreen> {
  final List<Exam> exams = [
    ...
    Exam(course: 'VNP', timestamp: DateTime(2024, 03, 29)),
    Exam(course: 'VP', timestamp: DateTime(2024, 04, 02))
  ];
